...
const LANG = {
  el: {
    ...
    hero_desc:'Μετατρέπουμε ιδέες σε πραγματικά, λειτουργικά προϊόντα, με ολοκληρωμένο μηχανολογικό σχεδιασμό, ανάλυση, κατασκευή και ψηφιακή παρουσία.',
    ...
    wd_off2_text:'Τα έργα σας σε μια γκαλερί που δείχνει τη δουλειά όπως της αξίζει.',
    ...
    sw_d_kicker4:'Τιμή',
    sw_pricing_lead:'Το Mechanical ExpertEase διατίθεται από <strong>80€ + ΦΠΑ / μήνα</strong>. Επιλέξτε το πακέτο που ταιριάζει στη ροή εργασίας σας και ζητήστε προσφορά ανάλογα με την περίπτωση.',
    ...
    swpb_title:'Απλά, διαφανή πακέτα τιμολόγισης.',
    swpb_sub:'',
    ...
    swpb_yr_desc:'Η καλύτερη αξία — πλήρης πρόσβαση ετησίως, προτεραιότητα υποστήριξης.',
  ...
  en: {
    ...
    hero_desc:'We turn ideas into real, working products, through complete mechanical design, analysis, fabrication and digital presence.',
    ...
    wd_off2_name:'Portfolio & Showcase',
    wd_off2_text:'Your projects in a gallery that shows the work as it deserves.',
    wd_off3_name:'Landing Pages',
    ...
    sw_pricing_lead:'Mechanical ExpertEase is available from <strong>80€ + VAT / month</strong>. Choose the plan that matches your workflow and request a custom offer depending on your case.',
    ...
    swpb_kicker:'Pricing',
    swpb_title:'Simple, transparent pricing plans.',
    swpb_sub:'',
    ...
    swpb_yr_desc:'Best value — full-year access, priority support.',
    ...
    swpb_footnote:'Special pricing available for 2+ licences — <a href="contact.html" id="swpb-footnote-link">contact us</a> for a quote.',
