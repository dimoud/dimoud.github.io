...
export const COMPONENTS = [
  ...
  { id: 'cover', pieces: 1,
    el: { name: 'Εμπρόσθιο καπάκι', qty: '1', mat: 'Αλουμίνιο 6082-T6, τορνευμένη όψη', spec: 'Δακτύλιος Ø138 / Ø114 × 3.5 mm · 8 οπές Ø5.5 · στεφάνη συγκράτησης κρυστάλλου', role: 'Κλείνει το κέλυφος και συγκρατεί αξονικά τη στεφάνη.' },
    en: { name: 'Front cover', qty: '1', mat: 'Aluminium 6082-T6, face-turned', spec: 'Ring Ø138 / Ø114 × 3.5 mm · 8 × Ø5.5 holes · crystal bezel', role: 'Closes the housing and axially retains the ring gear.' } },
  { id: 'glassF', pieces: 1,
    el: { name: 'Εμπρόσθιο κρύσταλλο', qty: '1', mat: 'Σκληρυμένο βοριοπυριτικό γυαλί, αντιανακλαστική επίστρωση', spec: 'Ø113 × 1 mm · οπή Ø20 για την πλήμνη', role: 'Κλείνει μπροστά το κέλυφος και αφήνει να φαίνεται ο μηχανισμός.' },
    en: { name: 'Front crystal', qty: '1', mat: 'Toughened borosilicate glass, anti-reflective coated', spec: 'Ø113 × 1 mm · Ø20 bore for the hub', role: 'Seals the front and keeps the mechanism on view.' } },
  { id: 'hub', pieces: 1,
  ...
  { id: 'glassB', pieces: 1,
    el: { name: 'Πίσω κρύσταλλο', qty: '1', mat: 'Σκληρυμένο βοριοπυριτικό γυαλί, ελαφρώς φιμέ', spec: 'Ø113 × 1.4 mm · οπή Ø39', role: 'Πίσω «καπάκι ρολογιού»: ο μηχανισμός φαίνεται και από πίσω.' },
    en: { name: 'Rear crystal', qty: '1', mat: 'Toughened borosilicate glass, light smoke tint', spec: 'Ø113 × 1.4 mm · Ø39 bore', role: 'Display caseback: the mechanism is visible from behind too.' } },
  { id: 'housing', pieces: 1,
    el: { name: 'Κέλυφος', qty: '1', mat: 'Αλουμίνιο 6082-T6, κατεργασμένο', spec: 'Ø138 × 21.5 mm · 3 βραχίονες στήριξης ρουλεμάν', role: 'Μεταλλικό στεφάνι που φέρει τη στεφάνη, το πίσω κρύσταλλο και το ρουλεμάν.' },
    en: { name: 'Housing', qty: '1', mat: 'Aluminium 6082-T6, machined', spec: 'Ø138 × 21.5 mm · 3 bearing support arms', role: 'Metal case ring carrying the ring gear, rear crystal and bearing.' } },
  { id: 'nuts', pieces: 16,
